...
<details>
<summary>Clique para ver todos os meus projetos</summary>

- **🏆 scrumframework**: Entrega do desafio Formação Scrum Master
- **📚 scrumcasodeestudo**: Estudo de caso sobre metodologia Scrum
- **🎮 nivelHeroiDio**: Projeto em Python para classificação de heróis
- **🎨 trilha-css-desafio-01**: Primeiro desafio da Trilha de CSS, construindo uma landing page
- **🎮 dio_dashboard_xbox**: Dashboard interativo para Xbox
- **📊 excel_irpflab**: Projeto de análise de dados com Excel
- **🤖 dio_excelcomia**: Arquivos dos projetos do curso Excel com IA da DIO
- **🎲 advinhanumero**: Jogo de advinhação em Python
- **🧠 LNN**: Framework `Neural = Symbolic` em Python
- **🎙️ prompts-for-podcast-generate-by-ia**: Prompts para criação de podcast com IA
- **🛒 dio.lab01.ecommerce**: Projeto de e-commerce
- **📄 chatpdfproject**: Sistema de chat com PDFs
- **🍦 icecreamdataproject**: Projeto de análise de dados sobre sorvetes
- **📈 dataproject**: Projeto de análise de dados
- **🚀 projectmegaapi**: API robusta em C#
- **🤖 lab-natty-or-not**: Lab "Natural ou Fake Natty? Como Vencer na Era das IAs Generativas!"
- **🌟 dio-lab-open-source**: Repositório do lab "Contribuindo em um Projeto Open Source no GitHub"
- **🎮 jsgame-detona-ralph**: Jogo do Detona Ralph feito com Javascript Vanilla
